...
class Enemy(arcade.Sprite):
    def __init__(self, position, enemy, speed, points, damage):
        super().__init__(enemy, center_x=position[0], center_y=position[1], scale = 1.25)
    ...
    def chooseEnemy(self):
        ...
        blue_enemy = Enemy((random.randrange(blue_position["min_x"], blue_position["max_x"]), random.randrange(blue_position["min_y"], blue_position["max_y"])), constants.enemyImages[2], constants.blueEnemySpeed, constants.blueEnemyPoints, constants.blueEnemyDamage)
